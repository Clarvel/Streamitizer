...
import { ConsolidatePaginated } from "../utils.js"
...
export class Picarto extends Provider(OAuth2PKCEAuth){
    ...
    async FetchStreams(auth, UID){
		...
		const followed = (await PromiseAll(["https://api.picarto.tv/api/v1/user/following", "https://api.picarto.tv/api/v1/user/subscriptions"].map(async api=>{
